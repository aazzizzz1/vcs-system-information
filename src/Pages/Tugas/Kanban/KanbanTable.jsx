...
const KanbanTable = () => {
  ...
  return (
    <>
                ...
                <tbody>
                  {data?.map((element) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                        {batasiKata(element?.job_description, 10)}
                      </td>
                      <td className="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                        {batasiKata(element?.job_qualification, 5)}
                      </td>
                      <td className="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                        <div className="flex items-center">
                          <svg
      ...
      >
        <div className="relative p-4 mt-60 w-full max-w-3xl h-full md:h-auto">
          {/* Modal content */}
          <div className="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            {/* Modal body */}
            <form action="#" onSubmit={handleCreateDataFinalProject}>
              <div className="grid gap-4 mb-4 sm:grid-cols-2">
                <div>
                  ...
                  <input
                    onChange={handleInputFinalProject}
                    value={inputFinalProject.title}
                    type="text"
                    name="title"
                    id="name"
                ...
                <div>
                  ...
                  <select
                    onChange={handleInputFinalProject}
                    value={inputFinalProject.job_description}
                ...
                <div>
                  ...
                  <input
                    onChange={handleInputFinalProject}
                    value={inputFinalProject.job_qualification}
                    type="text"
                ...
                <div>
                  ...
                  <input
                    onChange={handleInputFinalProject}
                    value={inputFinalProject.job_type}
                    type="text"
                    name="job_type"
                    id="price"
                    className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ...
                <div className="grid gap-4 sm:col-span-2 md:gap-6 sm:grid-cols-4">
                  <div>
                    ...
                    <input
                    onChange={handleInputFinalProject}
                    value={inputFinalProject.job_tenure}
                      type="text"
                      name="job_tenure"
                      id="weight"
                      className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                      placeholder="Bisa apa"
                      required
                    />
                  </div>
                  <div>
                    ...
                    <input
                      onChange={handleInputFinalProject}
                      value={inputFinalProject.job_status}
                      type="number"
                      name="job_status"
                      id="length"
                      className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                  ...
                  <div>
                    ...
                    <input
                      onChange={handleInputFinalProject}
                      value={inputFinalProject.company_name}
                      type="text"
                      name="company_name"
                      id="breadth"
                      className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                  ...
                  <div>
                    ...
                    <input
                      onChange={handleInputFinalProject}
                      value={inputFinalProject.company_city}
                      type="text"
                      name="company_city"
                      id="width"
                      className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ...
                <div>
                  ...
                  <input
                    onChange={handleInputFinalProject}
                    value={inputFinalProject.salary_min}
                    type="number"
                    name="salary_min"
                    id="brand"
                    className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ...
                <div>
                  ...
                  <input
                    onChange={handleInputFinalProject}
                    value={inputFinalProject.salary_max}
                    type="number"
                    name="salary_max"
                    id="price"
                    className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ...
                <div className="sm:col-span-2">
                  ...
                  <textarea
                    onChange={handleInputFinalProject}
                    value={inputFinalProject.company_image_url}
                    id="description"
