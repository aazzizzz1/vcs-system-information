...
const TableFinalProject = () => {
  // Destructuring state and functions from the context
  const { state, handleFunction } = useContext(GlobalContext);
  const { fetchStatus, setfetchStatus, data } = state;

  const { fetchDataFinalProject, batasiKata  } = handleFunction;
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                  <tr>
                    <th scope="col" classNamw="px-4 py-3">
                      Company
                    </th>
                ...
                <tbody>
                  {data?.map((element) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3">{batasiKata(element?.job_description, 20)}</td>
                      <td className="px-4 py-3">{batasiKata(element?.job_qualification, 15)}</td>
                      <td className="px-4 py-3">{element?.job_tenure}</td>
                      <td className="px-4 py-3">{element?.salary_max}</td>
                      <td className="px-4 py-3 flex items-center justify-end">
                        ...
                        >
                          <ul
                            className="py-1 text-sm text-gray-700 dark:text-gray-200"
                            aria-labelledby="apple-imac-27-dropdown"
                          >
                            <li>
                              <a
                                href="/"
...
export default TableFinalProject;